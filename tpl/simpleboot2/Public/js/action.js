...
function move(direction){
	...
	if(direction == 'r'){
		cur = cur + 1;
		img[5].style.left = "860px";
		hide = setInterval("right()", frequency);
		isRunning = 'true';
	}
	if(direction == 'l'){
		cur = cur - 1;
		img[5].style.left = "70px";
		var pos = position - 1;
		if(pos < 0)
			pos = pos + ad.length;
...
function reset(){
	...
	img[0].style.left = "160px";
	
	img[1].style.width = "100px";
	img[1].style.height = "75px";
	img[1].style.left = "270px";
	
	img[2].style.width = "150px";
	img[2].style.height = "110px";
	img[2].style.left = "410px";
	
	img[3].style.width = "100px";
	img[3].style.height = "75px";
	img[3].style.left = "600px";
	
	img[4].style.width = "70px";
	img[4].style.height = "50px";
	img[4].style.left = "740px";
	
	img[5].style.width = "0px";
	img[5].style.height = "0px";
	img[5].style.left = "860px";
}
